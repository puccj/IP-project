...
void fast_niblack(int** padded, int rows, int cols, double k, int w, int d, std::fstream& fout) {
...
cv::Mat fast_niblack(int** padded, int rows, int cols, int k, int w, int d, std::fstream& fout, int imgType) {
